...
### Reusing Precomputed Design Inputs

For repeated model runs on the same projected data/design, use the design-first
interface:
...
fit2 <- estimate_parametric_hrf_from_design(
  design = design,
