...
```{r}
# Design-first workflow (useful for repeated fits)
design <- create_parametric_design(fmri_data, events)
fit_design <- estimate_parametric_hrf_from_design(design = design, verbose = FALSE)
summary(fit_design)
```
