...
#'   and 0 elsewhere.
#' @param parametric_model Character string specifying the HRF model to use.
...
single_voxel_sanity_check <- function(
  ...
  # Create HRF interface (with default bounds)
  hrf_interface <- .create_hrf_interface(parametric_model, user_bounds = NULL)
